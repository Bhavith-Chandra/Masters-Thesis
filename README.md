...
- **16-Variable Structural Model**: A high-granularity DAG capturing the average participant's behavioral ecosystem.
- **Multi-Model Structural Comparison**: Mapping 4 structurally distinct machine-reasoning DAGs against human behavioral theory.
- **Quantitative Metrics**: Cross-validated R², RMSE, and PageRank Centrality analysis to identify "Global Behavioral Anchors".
- **Protocol Adherence**: Strict 5-line-per-cell code discipline with exhaustive scientific interpretation.

## 🎓 Research Team
- **Researcher**: Bhavith Chandra
- **Project**: Masters Thesis on Causal Behavioral Discovery & Machine Reasoning Extraction
